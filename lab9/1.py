...
SCORE = 0
COINS = 0
COINS_TO_SPEED_UP = 5  # Number of coins needed to increase enemy speed
...
def main():
    ...
    enemies.add(enemy)
    coins.add(coin)
    speed_up_counter = 0  # Counter to keep track of coins earned since last speed increase
    ...
    while running:
        ...
        if pygame.sprite.spritecollideany(player, coins):
            ...
            # Increment speed_up_counter and check if it's time to increase enemy speed
            if COINS - speed_up_counter >= COINS_TO_SPEED_UP:
                speed_up_counter = COINS
                enemy.speed += 1  # Increase enemy speed
                print("Enemy speed increased to:", enemy.speed)  # Optional: Print message indicating speed increase
